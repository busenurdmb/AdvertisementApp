...
namespace AdvertisementApp.UI.Controllers
{
    public class AdvertisementController : Controller
    {
        ...
        public async Task<IActionResult> Send(int advertisementıd)
        {
            var userId = int.Parse((User.Claims.FirstOrDefault(x => x.Type == ClaimTypes.NameIdentifier)).Value);
            var userresponse=await _appUserService.GetByIdAsync<AppUserListDtos>(userId);
           
            ViewBag.genderıd = userresponse.Data.GenderId;
            ...
            { 
                AdvertisementId=advertisementıd,
                AppUserId=userId,
        ...
        public async Task<IActionResult> Send(AdvertisementAppUserCreateModel model)
        {
            ...
            dto.AdvertisementUserStatusId = model.AdvertisementUserStatusId;
        ...
        [Authorize(Roles ="Admin")]
        public async Task<IActionResult> SetStatus(int advertisementappuserıd,AdvertisementAppUserStatusType type) 
        {
            await _advertisementAppUserService.SetStatusAsync(advertisementappuserıd, type);
            return View("List");
        }
        [Authorize(Roles ="Admin")]
