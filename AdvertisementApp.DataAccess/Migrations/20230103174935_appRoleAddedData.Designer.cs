...
namespace AdvertisementApp.DataAccess.Migrations
{
    ...
    [Migration("20230103174935_appRoleAddedData")]
    partial class appRoleAddedData
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvertisementApp.Entities.AppUserRole", b =>
                {
                    b.HasOne("AdvertisementApp.Entities.AppRole", "Role")
                        .WithMany("AppUserRoles")
                        .HasForeignKey("AppRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AdvertisementApp.Entities.AppUser", "User")
                        .WithMany("AppUserRoles")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
